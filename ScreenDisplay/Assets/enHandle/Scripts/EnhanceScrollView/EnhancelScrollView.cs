...
public class EnhancelScrollView :MonoBehaviour
{
    ...
    private List<RawImage> textureTargets;
    ...
    public void SortDepth()
    {
        ...
        {
            textureTargets[i].gameObject.GetComponent<RectTransform>().SetSiblingIndex(i);
        }
    }
    ...
    /// 用于层级对比接口
    /// </summary>
    public class CompareDepthMethod : IComparer<RawImage>
    {
        public int Compare(RawImage left, RawImage right)
        {
